...
objArrayEstados = [
    ...
    ['Distrito Federal', 'Cerrado', 'Tropical', 'N', 'N', 254817, 3094325, 10222],
    ...
    ['Mato Grosso', 'Pantanal', 'Equatorial', 'N', 'S', 137443, 3567234, 13655],
    ['Mato Grosso do Sul', 'Pantanal', 'Tropical', 'N', 'S', 106969, 2839188, 9468],
